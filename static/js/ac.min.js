...
$jscomp.asyncExecutePromiseGenerator=function(v){function D(E){return v.next(E)}function I(E){return v.throw(E)}return new Promise(function(E,O){function R(F){F.done?E(F.value):Promise.resolve(F.value).then(D,I).then(R,O)}R(v.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(v){return $jscomp.asyncExecutePromiseGenerator(v())};$jscomp.asyncExecutePromiseGeneratorProgram=function(v){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(v)))};
$jscomp.polyfill("Array.prototype.includes",function(v){return v?v:function(D,I){var E=this;E instanceof String&&(E=String(E));var O=E.length;I=I||0;for(0>I&&(I=Math.max(I+O,0));I<O;I++){var R=E[I];if(R===D||Object.is(R,D))return!0}return!1}},"es7","es3");$jscomp.polyfill("Promise.prototype.finally",function(v){return v?v:function(D){return this.then(function(I){return Promise.resolve(D()).then(function(){return I})},function(I){return Promise.resolve(D()).then(function(){throw I;})})}},"es9","es3");
var acapi=function(v){function D(a){function b(c,e){return c.reduce(function(d,h){var g;Array.isArray(h)&&(g=b(h,e+1));return g>d?g:d},e)}return b(a,1)}function I(a){let b=a.length,c=Array(b),e;for(let d=0;d<b;d++)e=a.charCodeAt(d),e=48<=e&&58>e?e-48:(e&223)-65+10,c[d]=e;return c.reduce((d,h)=>16*d+h,0)}function E(a){if(void 0!=a){var b=[];if(/^(rgb|RGB)/.test(a)){a=a.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(",");for(let c of a)b.push(Number((Number(c)/255).toFixed(1)))}else if(/^#/.test(a)){if(/^#[0-9A-F]{3}$/i.test(a)){let c=
"#";a.replace(/[0-9A-F]/ig,function(e){c+=e+e});a=c}/^#[0-9A-F]{6}$/i.test(a)&&a.replace(/[0-9A-F]{2}/ig,function(c){c=I(c);b.push(Number((c/255).toFixed(1)))})}else a instanceof Array&&(b=a);3==b.length&&b.push(1);return b}}function O(a){if(void 0!=a){var b,c=D(a);2==c?b=[[a]]:3==c?b=[a]:4==c&&(b=a);if(b)for(let e of b)for(let d of e)for(let h of d)2==h.length&&h.push(0);return b}}function R(a){if(void 0!=a)return 1==D(a)?[a]:a}function F(a){return a instanceof Array?a:[a]}function K(a){let b=[];
if(a instanceof Array)for(let c in a)b[c]=a[c].toString();else b=[a.toString()];return b}function S(a){switch(typeof a){case "undefined":return!0;case "string":if(0===a.replace(/(^[ \t\n\r]*)|([ \t\n\r]*$)/g,"").length)return!0;break;case "boolean":if(!a)return!0;break;case "number":if(isNaN(a))return!0;break;case "object":if(null===a||0===a.length)return!0;for(var b in a)return!1;return!0}return!1}function pa(a,b){for(a=a.toString();a.length<b;)a="0"+a;return a}function Ga(a,b){let c,e=0;return function(...d){const h=
this,g=+new Date,q=b-(g-e);0>=q?(e=g,a.apply(h,d),c&&(clearTimeout(c),c=null)):c||(c=setTimeout(()=>{e=+new Date;c=null;a.apply(h,d)},q))}}function Ha(a){switch(a){case da.StartingProcess:return"starting process...";case da.CheckingBusy:return"checking...";case da.ProcessStartFailed:return"process start failed!";case da.ProcessStarted:return"process started";case da.LoadingProject:return"loading project...";case da.ProjectLoaded:return"project loaded"}}function wa(a){"string"===typeof a&&(a=document.getElementById(a));
return a}function Ia(a){return T.isIOSDevice&&T.isInWeixinBrowser?!1:a==sa.abnormal||a==sa.instance_disconnected}function aa(a,b){return void 0!==a&&null!==a?a:b}function xa(a){return a.keyCode===ea.Shift&&"ShiftRight"===a.code?ea.RightShift:a.keyCode===ea.Control&&"ControlRight"===a.code?ea.RightControl:a.keyCode===ea.Alt&&"AltRight"===a.code?ea.RightAlt:a.keyCode}var p={None:0,Camera_PlayAnimation:1,Camera_StopAnimation:2,Misc_EnterReportMode:3,Misc_ExitReportMode:4,Misc_SetDateTime:5,Camera_GetCamera:6,
...
a.toString();this.color=E(b);this.coordinates=c;this.style=void 0==e?0:e;if(0>this.style||5<this.style)this.style=0;this.thickness=void 0==d?20:d;this.brightness=void 0==h?.5:h;this.flowRate=void 0==g?.5:g;this.tiling=q||0;this.depthTest=k||!0;this.shape=void 0==f?0:f}}class Va{constructor(a,b,c,e,d,h,g,q,k,f,l,t,w,r,y,u,A){this.id=a.toString();this.color=E(b);this.coordinates=c;this.flowRate=void 0==e?.5:e;this.brightness=void 0==d?.5:d;this.bendDegree=void 0==h?.5:h;this.tiling=g||0;this.lineThickness=
void 0==q?20:q;this.flowPointSizeScale=void 0==k?20:k;this.labelSizeScale=void 0==f?100:f;this.lineShape=void 0==l?1:l;this.lineStyle=t||0;this.flowShape=w||0;this.startPointShape=r||0;this.endPointShape=y||0;this.startLabelShape=u||0;this.endLabelShape=A||0;this.endLabelStyle=this.startLabelStyle=this.endPointStyle=this.startPointStyle=this.flowStyle=0}}class Wa{constructor(a,b,c,e,d,h,g,q){this.id=a.toString();this.color=E(b);this.coordinates=O(c);this.framecolor=E(e);this.framethickness=d;this.depthTest=
h||!0;this.brightness=g;this.style=q;if(0>this.style||10<this.style)this.style=0}}class Xa{constructor(a,b,c,e,d,h){this.id=a.toString();this.imagePath=b;this.coordinate=c;this.yaw=e;this.groupId=d||"";this.userData=h||""}}class Ya{constructor(a,b,c,e,d,h,g,q){this.id=a.toString();this.order=b;this.texturePath=c;this.location=e;this.rotation=d;this.scale=h;this.groupId=g;this.userData=q}}class Za{constructor(a,b,c,e,d){this.id=a.toString();this.fileName=b;this.location=c;this.rotation=e;this.scale=
d}}class $a{constructor(a,b,c,e,d,h,g){this.id=a;this.pakFilePath=b;this.assetPath=c;this.location=e;this.rotation=d;this.scale=h;this.smoothMotion=g}}class ab{constructor(a,b,c,e,d,h,g){this.id=a;this.tileLayerId=b;this.objectId=c;this.location=e;this.rotation=d;this.scale=h;this.smoothMotion=g}}class bb{constructor(a,b,c,e,d,h,g){this.id=a;this.videoURL=b;this.location=c;this.rotation=e;this.fov=d;this.aspectRatio=h;this.distance=g}}class cb{constructor(a,b,c,e,d){this.id=a;this.coordinates=O(b);
this.style=c;this.groupId=e;this.userData=d}}class db{constructor(a,b,c,e,d){this.actorTag=a;this.objectName=b;this.functionName=c;this.paramType=e;this.paramValue=d}}class fa{constructor(a,b){this.tileLayerId=a;this.tileLayerActorNames=K(b)}}class eb{constructor(a,b,c,e){this.index=a;this.time=b;this.location=c;this.rotation=e}}class fb{constructor(a,b,c){this.id=a.toString();this.name=b.toString();this.keyFrames=c}}class gb{constructor(){this.queue=[];this.dataMap=new Map}enqueue(a){if(null==a||
void 0==a||!a.callbackIndex)return!1;this.queue.push(a.callbackIndex);this.dataMap.set(a.callbackIndex,a);return!0}dequeue(){if(0!=this.queue.length){const a=this.queue.shift();return this.dataMap.get(a)}}removeData(a){this.dataMap.has(a)&&this.dataMap.delete(a)}dataSize(){return this.dataMap.size}queueSize(){return this.queue.length}}class hb extends gb{constructor(a){super();this.onSendAPI=a;this.timer=null;this.isMainThreadBusy=!1}onMainThreadBusy(a){this.isMainThreadBusy=a.busy}push(a){if(a.__noResponse)this.onSendAPI(a);
else 0==this.dataSize()?(this.enqueue(a),this.callNext()):1E4<this.dataSize()?console.warn("The api queue has exceeded 10000, and subsequent calls will be ignored!"):this.enqueue(a)}callNext(a){a&&this.removeData(a);this.timer&&clearTimeout(this.timer);0!=this.dataSize()&&(a=this.dequeue())&&(this._callNextForTimeout(3E3),this.onSendAPI(a))}_callNextForTimeout(a){this.timer=setTimeout(()=>{this.isMainThreadBusy?this._callNextForTimeout(5E3):this.callNext()},a)}}class Q{constructor(a,b,c){this.int=
a;this.type=b;this.colorProps=c;this._useBatchUpdate=!1;this._tempUpdateData=[]}_checkCommand(a){a=this.type+a;let b=p[a];void 0==b&&this.int.logWithColor("red",`Invalid command: ${a}`);return b}_convertFilePath(a){return this.int.resourcesPath?a.replace("@path:",this.int.resourcesPath+"/"):a}_processProps(a){a=F(a);for(var b of a)for(let e in b)"string"==typeof b[e]&&b[e].startsWith("@path:")&&(b[e]=this._convertFilePath(b[e]));for(let e of a)"string"!=typeof e.id&&(e.id=e.id.toString());if(this.colorProps){b=
this.colorProps.split("|");for(var c of a)for(let e of b)c.hasOwnProperty(e)&&(c[e]=E(c[e]))}if(-1!=["Polygon","Polygon3D","HighlightArea","DynamicWater"].indexOf(this.type))for(let e of a)e.coordinates=O(e.coordinates);for(let e of a)e.hasOwnProperty("userData")&&(c=e.userData,this._isJsonString(c)&&(e.userData=c.replace(/"/g,"~!@~!@~!@")))}_isJsonString(a){try{return"string"===typeof a?(JSON.parse(a),!0):!1}catch(b){return!1}}_add(a,b){this._processProps(a);return this.int.call({command:this._checkCommand("_Add"),
data:F(a)},b)}_update(a,b){this._processProps(a);return this.int.call({command:this._checkCommand("_Update"),data:F(a)},b)}_delete(a,b){return this.int.call({command:this._checkCommand("_Delete"),ids:K(a)},b)}_clear(a){return this.int.call0(this._checkCommand("_Clear"),a)}_get(a,b){return this.int.call({command:this._checkCommand("_Get"),ids:K(a)},b)}_focus(a,b,c,e,d){"function"==typeof c&&(d=c,c=void 0);"function"==typeof e&&(d=e,e=null);return this.int.call({command:this._checkCommand("_Focus"),
ids:K(a),distance:b||0,flyTime:c,rotation:e},d)}_focusAll(a,b,c,e){"function"==typeof b&&(e=b,b=void 0);"function"==typeof c&&(e=c,c=null);return this.int.call({command:this._checkCommand("_FocusAll"),ids:[],distance:a||0,flyTime:b,rotation:c},e)}_show(a,b){return this.int.call({command:this._checkCommand("_Show"),ids:K(a)},b)}_showAll(a){return this.int.call0(this._checkCommand("_ShowAll"),a)}_hide(a,b){return this.int.call({command:this._checkCommand("_Hide"),ids:K(a)},b)}_hideAll(a){return this.int.call0(this._checkCommand("_HideAll"),
a)}_updateOneProp(a,b,c,e){if(this._useBatchUpdate){e=!1;for(var d of this._tempUpdateData)if(d.id==a.toString()){e=!0;d[b]=c;break}e||(e={},e.id=a.toString(),e[b]=c,this._tempUpdateData.push(e))}else return d={},d.id=a.toString(),d[b]=c,this.update(d,e)}updateBegin(){this._useBatchUpdate=!0;this._tempUpdateData=[]}updateEnd(a){a=this.update(this._tempUpdateData,a);this._tempUpdateData=null;this._useBatchUpdate=!1;return a}test(){alert("test")}}class ib extends Q{constructor(a){super(a,"Beam","color")}add(a,
b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setDuration(a,b,c){return super._updateOneProp(a,"duration",b,c)}setThickness(a,b,c){return super._updateOneProp(a,"thickness",b,c)}setInterval(a,b,
c){return super._updateOneProp(a,"interval",b,c)}setVelocity(a,b,c){return super._updateOneProp(a,"velocity",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}}class jb extends Q{constructor(a){super(a,"CameraTour")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}play(a,b){return this.int.call({command:p.CameraTour_Play,ids:K(a)},b)}pause(a){return this.int.call0(p.CameraTour_Pause,
a)}resume(a){return this.int.call0(p.CameraTour_Resume,a)}stop(a){return this.int.call({command:p.CameraTour_Stop},a)}setUserData(a,b,c){return super._updateOneProp(a,"userData",b,c)}setDuration(a,b,c){return super._updateOneProp(a,"duration",b,c)}setKeyFrames(a,b,c){return super._updateOneProp(a,"keyFrames",b,c)}setName(a,b,c){return super._updateOneProp(a,"name",b,c)}}class kb extends Q{constructor(a){super(a,"Cesium3DTile")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,
b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setTileURL(a,b,c){return super._updateOneProp(a,"tileURL",b,c)}}class lb extends Q{constructor(a){super(a,"CustomMesh","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,
b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setIndices(a,b,c){return super._updateOneProp(a,"indices",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",b,c)}}class mb extends Q{constructor(a){super(a,"CustomObject")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,
b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d,h){"function"==typeof c&&(h=c,c=void 0);"function"==typeof e&&(h=e,e=null);"function"==typeof d&&(h=d,d=0);1<d&&(e=2==d?[-45,0,0]:3==d?[0,0,0]:4==d?[-90,0,0]:5==d?[90,0,0]:6==d?[0,90,0]:7==d?[0,270,0]:[0,0,0]);!S(a)&&-1==b&&S(c)&&S(e)&&S(d)&&(d=1,b=0);return this.int.call({command:p.CustomObject_Focus,ids:K(a),distance:b||0,flyTime:c,rotation:e||null,follow:d||0},h)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}get(a,b){return super._get(a,b)}addByTileLayer(a,b){if(a instanceof Array)for(let c of a)this._fixTileLayerProperty(c);else this._fixTileLayerProperty(a);return this.int.call({command:p.CustomObject_AddByTileLayer,data:F(a)},b)}_fixTileLayerProperty(a){a.tileLayerId instanceof Array||(a.tileLayerId=F(a.tileLayerId));a.objectId instanceof Array||(a.objectId=F(a.objectId))}highlight(a,b){return this.int.call({command:p.CustomObject_Highlight,ids:K(a)},b)}unhighlight(a,b){return"undefined"==typeof a||
"function"==typeof a?("function"==typeof a&&(b=a),this.int.call({command:p.CustomObject_StopHighlight},b)):this.int.call({command:p.CustomObject_Unhighlight,ids:K(a)},b)}glow(a,b){if(a instanceof Array)for(let c of a){let e;e=E(c.color);c.colors=[{color:[e[0]/2,e[1]/2,e[2]/2],value:0},{color:c.color,value:1}]}else o.colors=[{color:o.color,value:0},{color:o.color,value:1}];return this.int.call({command:p.CustomObject_StartGlow,data:F(a)},b)}stopGlow(a,b){return this.int.call({command:p.CustomObject_StopGlow,
ids:K(a)},b)}getBPFunction(a,b){return this.int.call({command:p.Misc_QueryActorOrMaterial,idOrPaths:F(a)},b)}callBPFunction(a,b,c,e,d,h){this.callFunction(a,b,c,e,d,h)}callFunction(a,b,c,e,d,h){return this.int.call({command:p.CustomObject_CallFunction,data:F({id:a.toString(),functionName:b,paramType:c,paramValue:e,parameters:d})},h)}callBatchBPFunction(a,b){this.callFunction4CustomObjectArr(a,b)}callBatchFunction(a,b){this.callFunction4CustomObjectArr(a,b)}callFunction4CustomObjectArr(a,b){return this.int.call({command:p.CustomObject_CallFunction,
data:F(a)},b)}setLocation(a,b,c,e){return"function"==typeof c?super._updateOneProp(a,"location",b,c):"number"==typeof c?this.int.call({command:p.CustomObject_Update,data:[{id:a,location:b,smoothTime:c}]},e):super._updateOneProp(a,"location",b,e)}setSmoothTime(a,b,c){return super._updateOneProp(a,"smoothTime",b,c)}moveTo(a,b){return this.int.call({command:p.CustomObject_Update,data:F(a)},b)}setRotation(a,b,c){return super._updateOneProp(a,"rotation",b,c)}setLocalRotation(a,b,c){return super._updateOneProp(a,
"localRotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}setSmoothMotion(a,b,c){return super._updateOneProp(a,"smoothMotion",b,c)}setTintColor(a,b,c){a={ids:F(a),color:E(b)};return this.int.call({command:p.CustomObject_SetTintColor,data:F(a)},c)}overrideMaterial(a,b){return this.int.call({command:p.CustomObject_OverrideMaterial,data:F(a)},b)}restoreMaterial(a,b){return this.int.call({command:p.CustomObject_RestoreMaterial,ids:F(a)},b)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,
viewportVisible:!!(b&ba.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&ba.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&ba.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&ba.V4)});return this.int.call({command:p.CustomObject_SetViewportVisible,id:a,data:e},c)}startMove(a,b,c,e){return this.int.call({command:p.CustomObject_StartMove,id:a,coordinateType:b,data:F(c)},e)}stopMove(a,b){return this.int.call({command:p.CustomObject_StopMove,id:a},b)}}class nb extends Q{constructor(a){super(a,
...
b,c)}}class ob extends Q{constructor(a){super(a,"Decal")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}get(a,b){return super._get(a,b)}}class pb extends Q{constructor(a){super(a,"DynamicWater")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",O(b),c)}setMaterialPath(a,b,c){return super._updateOneProp(a,"materialPath",b,c)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}}class qb extends Q{constructor(a){super(a,"FloodFill","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setRange(a,b,c,e){b instanceof Array&&c instanceof Array?0<b.length&&0<c.length?this.update({id:a,min:b,max:c},e):console.error("\u6570\u7ec4\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a."):console.error("\u6570\u7ec4\u53c2\u6570\u683c\u5f0f\u4e0d\u6b63\u786e.")}setMin(a,b,c){return super._updateOneProp(a,
"min",b,c)}setMax(a,b,c){return super._updateOneProp(a,"max",b,c)}setSeed(a,b,c){return super._updateOneProp(a,"seed",b,c)}setElevation(a,b,c){return super._updateOneProp(a,"elevation",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setPrecision(a,b,c){return super._updateOneProp(a,"precision",b,c)}}class rb extends Q{constructor(a){super(a,"GeoJSONLayer")}load(a,b){return super._add(a,b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}delete(a,b){return super._delete(a,
b)}}class sb extends Q{constructor(a){super(a,"HeatMap")}_checkBBox(a){if(a instanceof Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;return!0}add(a,b,c,e,d,h,g,q,k,f,l){return this._checkBBox(b)?"undefined"==typeof d||"function"==typeof d?this.int.call({command:p.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:F(e),style:-1},l):0==d?this.int.call({command:p.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:F(e),style:0,textureSize:h,opacityMode:g,opacityRange:q,blur:k,
colors:f},l):this.int.call({command:p.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:F(e),style:-1},l):(this.int.logWithColor("red","Invalid bbox value"),!1)}update(a,b,c,e,d){a={command:p.HeatMap_Update,id:a.toString()};if(b){if(!this._checkBBox(b))return this.int.logWithColor("red","Invalid bbox value"),!1;a.bbox=b}c&&(a.range=c);e&&(a.data=F(e));return this.int.call(a,d)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,
b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}addPoints(a,b,c){return this.int.call({command:p.HeatMap_AddPoints,id:a,data:F(b)},c)}removePoints(a,b,c){return this.int.call({command:p.HeatMap_RemovePoints,id:a,pointIds:F(b)},c)}setRange(a,b,c){return this.int.call({command:p.HeatMap_Update,id:a,range:b},c)}setBBox(a,b,c){return this._checkBBox(b)?this.int.call({command:p.HeatMap_Update,id:a,bbox:b},c):(this.int.logWithColor("red","Invalid bbox value"),
...
"popupOffset",b,c)}setLineSize(a,b,c){return super._updateOneProp(a,"lineSize",b,c)}setLineColor(a,b,c){return super._updateOneProp(a,"lineColor",b,c)}setLineOffset(a,b,c){return super._updateOneProp(a,"lineOffset",b,c)}setPriority(a,b,c){return super._updateOneProp(a,"priority",b,c)}setOcclusionCull(a,b,c){return super._updateOneProp(a,"occlusionCull",b,c)}setAttachCustomObject(a,b){return this.int.call({command:p.Marker_SetupPOIAttachment,data:F(a)},b)}showByGroupId(a,b){return this.int.call({command:p.Marker_ShowByGroupId,
ids:F(a)},b)}hideByGroupId(a,b){return this.int.call({command:p.Marker_HideByGroupId,ids:F(a)},b)}deleteByGroupId(a,b){return this.int.call({command:p.Marker_DeleteByGroupId,ids:F(a)},b)}}class yb extends Q{constructor(a){super(a,"Marker3D","textColor|textOutlineColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,
b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}showByGroupId(a,b){return this.int.call({command:p.Marker3D_ShowByGroupId,groupId:a},b)}hideByGroupId(a,b){return this.int.call({command:p.Marker3D_HideByGroupId,groupId:a},b)}deleteByGroupId(a,b){return this.int.call({command:p.Marker3D_DeleteByGroupId,groupId:a},b)}}class zb extends Q{constructor(a){super(a,"ODLine","color")}add(a,b){this._fixODlineData(a);return super._add(a,b)}_fixODlineProperty(a){a.intensity&&
(a.brightness=a.intensity)}_fixODlineData(a){if(a instanceof Array)for(let b of a)this._fixODlineProperty(b);else this._fixODlineProperty(a)}update(a,b){this._fixODlineData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,
...
"startLabelShape",b,c)}setEndLabelShape(a,b,c){return super._updateOneProp(a,"endLabelShape",b,c)}}class Ab extends Q{constructor(a){super(a,"Panorama")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}get(a,b){return super._get(a,b)}enter(a,b){return this.int.call({command:p.Panorama_Enter,ids:K(a)},b)}exit(a){return this.int.call({command:p.Panorama_Exit},a)}switchMode(a){return this.int.call({command:p.Panorama_Switch},
a)}}class Bb extends Q{constructor(a){super(a,"Polygon","color|frameColor")}add(a,b){this._fixPolygonData(a);return super._add(a,b)}_fixPolygonProperty(a){a.intensity&&(a.brightness=a.intensity)}_fixPolygonData(a){if(a instanceof Array)for(let b of a)this._fixPolygonProperty(b);else this._fixPolygonProperty(a)}update(a,b){this._fixPolygonData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,
b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}glow(a,b,c){return this.int.call({command:p.Polygon_Glow,ids:K(a),duration:b},c)}highlight(a,b){return this.int.call({command:p.Polygon_Highlight,ids:K(a)},b)}stopHighlight(a,b){return this.int.call({command:p.Polygon_StopHighlight,ids:K(a)},b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",O(b),c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",
b,c)}}class Cb extends Q{constructor(a){super(a,"Polygon3D","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}highlight(a,b){return this.int.call({command:p.Polygon3D_Highlight,ids:K(a)},
b)}stopHighlight(a,b){return this.int.call({command:p.Polygon3D_StopHighlight,ids:K(a)},b)}glow(a,b,c){return this.int.call({command:p.Polygon3D_Glow,ids:K(a),duration:b},c)}stopGlow(a,b){return this.int.call({command:p.Polygon3D_StopGlow,ids:K(a)},b)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setHeight(a,b,c){return super._updateOneProp(a,"height",b,
c)}setIntensity(a,b,c){return super._updateOneProp(a,"intensity",b,c)}setTillingX(a,b,c){return super._updateOneProp(a,"tillingX",b,c)}setTillingY(a,b,c){return super._updateOneProp(a,"tillingY",b,c)}}class Db extends Q{constructor(a){super(a,"Polyline","color")}add(a,b){this._fixPolylineData(a);return super._add(a,b)}_fixPolylineProperty(a){a.intensity&&(a.brightness=a.intensity)}_fixPolylineData(a){if(a instanceof Array)for(let b of a)this._fixPolylineProperty(b);else this._fixPolylineProperty(a)}update(a,
b){this._fixPolylineData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}setThickness(a,b,c){return super._updateOneProp(a,
"thickness",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setFlowRate(a,b,c){return super._updateOneProp(a,"flowRate",b,c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setShape(a,b,c){return super._updateOneProp(a,"shape",b,c)}setDepth(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class Eb extends Q{constructor(a){super(a,"RadiationPoint","color")}add(a,b){this._fixRadiationPointData(a);return super._add(a,b)}_fixRadiationPointProperty(a){a.intensity&&
(a.brightness=a.intensity)}_fixRadiationPointData(a){if(a instanceof Array)for(let b of a)this._fixRadiationPointProperty(b);else this._fixRadiationPointProperty(a)}update(a,b){this._fixRadiationPointData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,
b){return super._get(a,b)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",b,c)}setRadius(a,b,c){return super._updateOneProp(a,"radius",b,c)}setRippleNumber(a,b,c){return super._updateOneProp(a,"rippleNumber",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setAutoHeight(a,b,c){return super._updateOneProp(a,"autoHeight",b,c)}}class Fb extends Q{constructor(a){super(a,"ShapeFileLayer","color")}add(a,
b){return super._add(a,b)}update(a,b){return super._update(a,b)}_fix_property(a){if(a instanceof Array){let b=[];for(let c of a)S(c.cacheAllField)&&(c.cacheAllField=!1,b.push(c));a=b}else S(a.cacheAllField)&&(a.cacheAllField=!1);return a}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}get(a,b){return super._get(a,b)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}open(a,
b){return this.int.call({command:p.ShapeFileLayer_OpenShapeFileLayer,data:F(a)},b)}highlightFeature(a,b,c){return this.int.call({command:p.ShapeFileLayer_HighlightFeature,data:F({shpId:a,featureIds:[b]})},c)}stopHighlightFeature(a,b,c){return this.int.call({command:p.ShapeFileLayer_UnHighlightFeature,data:F({shpId:a,featureIds:[b]})},c)}highlightFeatures(a,b){return this.int.call({command:p.ShapeFileLayer_HighlightFeature,data:F(a)},b)}stopHighlightFeatures(a,b){return this.int.call({command:p.ShapeFileLayer_UnHighlightFeature,
data:F(a)},b)}focusFeature(a,b,c,e,d,h){return this.int.call({command:p.ShapeFileLayer_FocusFeature,data:F({shpId:a,featureIds:[b]}),distance:c,flyTime:e,rotation:d},h)}getFeature(a,b){return this.int.call({command:p.ShapeFileLayer_GetFeatureInfo,data:F(a)},b)}}class Gb extends Q{constructor(a){super(a,"Tag","textColor|textBackgroundColor|textBorderColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",b,c)}setImagePath(a,b,c){return super._updateOneProp(a,"imagePath",b,c)}setImageSize(a,b,c){return super._updateOneProp(a,"imageSize",b,c)}setText(a,b,c){return super._updateOneProp(a,
"text",b,c)}setRange(a,b,c){return super._updateOneProp(a,"range",b,c)}setTextColor(a,b,c){return super._updateOneProp(a,"textColor",b,c)}setTextBackgroundColor(a,b,c){return super._updateOneProp(a,"textBackgroundColor",b,c)}setTextBorderColor(a,b,c){return super._updateOneProp(a,"textBorderColor",b,c)}setShowLine(a,b,c){return super._updateOneProp(a,"showLine",b,c)}setAutoHidePopupWindow(a,b,c){return super._updateOneProp(a,"autoHidePopupWindow",b,c)}setURL(a,b,c){return super._updateOneProp(a,"url",
b,c)}showPopupWindow(a,b){return this.int.call({command:p.Tag_PopupWindow_Show,ids:K(a)},b)}hidePopupWindow(a,b){return this.int.call({command:p.Tag_PopupWindow_Hide,ids:K(a)},b)}showAllPopupWindow(a){return this.int.call0(p.Tag_PopupWindow_ShowAll,a)}hideAllPopupWindow(a){return this.int.call0(p.Tag_PopupWindow_HideAll,a)}}class Hb extends Q{constructor(a){super(a,"TileLayer")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,
e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}getAllFlattenInfo(a){return this.int.call({command:p.TileLayer_GetAllFlattenData},a)}getActorInfoFromDB(a,b){return this.int.call({command:p.TileLayer_GetActorInfoFromDB,data:F(a)},b)}enableXRay(a,b,c){return this.int.call({command:p.TileLayer_EnableXRay,ids:K(a),color:E(b)},c)}disableXRay(a,b){return this.int.call({command:p.TileLayer_DisableXRay,ids:K(a)},b)}enableClip(a,
b){let c=[];a=F(a);for(let e of a)c.push({id:e,allowClip:!0});return this.int.call({command:p.TileLayer_SetAllowClip,data:c},b)}disableClip(a,b){let c=[];a=F(a);for(let e of a)c.push({id:e,allowClip:!1});return this.int.call({command:p.TileLayer_SetAllowClip,data:c},b)}setFileName(a,b,c){return super._updateOneProp(a,"fileName",b,c)}setLocation(a,b,c){return super._updateOneProp(a,"location",b,c)}setTranslation(a,b,c){return this.setLocation(a,b,c)}setRotation(a,b,c){return super._updateOneProp(a,
"rotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}showActor(a,b,c){a=new fa(a,b);return this.int.call({command:p.TileLayer_Actor_Show,data:F(a)},c)}showActors(a,b){let c=[];if(a instanceof Array)for(let d=0;d<a.length;d++){var e=a[d];e={tileLayerId:e.id,tileLayerActorNames:K(e.objectIds)};c.push(e)}else a={tileLayerId:a.id,tileLayerActorNames:K(a.objectIds)},c.push(a);return this.int.call({command:p.TileLayer_Actor_Show,data:c},b)}hideActor(a,b,c){a=new fa(a,b);return this.int.call({command:p.TileLayer_Actor_Hide,
data:F(a)},c)}hideActors(a,b){let c=[];if(a instanceof Array)for(let d=0;d<a.length;d++){var e=a[d];e={tileLayerId:e.id,tileLayerActorNames:K(e.objectIds)};c.push(e)}else a={tileLayerId:a.id,tileLayerActorNames:K(a.objectIds)},c.push(a);return this.int.call({command:p.TileLayer_Actor_Hide,data:c},b)}focusActor(a,b,c,e,d,h){a=new fa(a,b);return this.int.call({command:p.TileLayer_Actor_Focus,data:F(a),distance:c,flyTime:e,rotation:d},h)}focusActors(a,b,c,e,d){a=new fa(a.id,a.objectIds);return this.int.call({command:p.TileLayer_Actor_Focus,
data:F(a),distance:b,flyTime:c,rotation:e},d)}highlightActor(a,b,c){a=new fa(a,b);return this.int.call({command:p.TileLayer_Actor_Highlight,data:F(a)},c)}stopHighlightActor(a,b,c){let e=void 0==a;"function"==typeof a&&(c=a,e=!0);if(e)return this.stopHighlightActors(c);if(S(a)||S(b))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else return this.stopHighlightActors({id:a,objectIds:[b]},c)}highlightActors(a,b){return this.int.call({command:p.TileLayer_Actor_Highlight,data:this._fix_highlight_actors_data(a)},
b)}stopHighlightActors(a,b){let c=!a;"function"==typeof a&&(b=a,c=!0);return c?this.int.call0(p.TileLayer_Actor_StopHightlight,b):this.int.call({command:p.TileLayer_Actor_Unhighlight,data:this._fix_highlight_actors_data(a)},b)}_fix_highlight_actors_data(a){if(S(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{var b=[];if(a instanceof Array)for(let c=0;c<a.length;c++){let e=new fa(a[c].id,a[c].objectIds);b.push(e)}else a=new fa(a.id,a.objectIds),b.push(a);return b}}stopHighlightAllActors(a){return this.int.call0(p.TileLayer_Actor_StopHightlight,
a)}showAllActors(a,b){return this.int.call({command:p.TileLayer_Actor_ShowAll,ids:K(a)},b)}hideAllActors(a,b){return this.int.call({command:p.TileLayer_Actor_HideAll,ids:K(a)},b)}setStyle(a,b,c,e,d,h,g,q){return this.int.call({command:p.TileLayer_SetStyle,ids:K(a),style:b,color:E(c),saturation:e,brightness:d,contrast:h,contrastbase:g},q)}setCollision(a,b,c,e,d,h){a=K(a);let g=[];for(let q of a)g.push({id:q,enableCollision:b,enableMouseRoma:c,enableFunctionInteract:e,enableCharacterCollision:d});return this.int.call({command:p.TileLayer_SetCollision,
data:g},h)}getCollision(a,b){return this.int.call({command:p.TileLayer_GetCollision,ids:K(a)},b)}addModifiers(a,b){return this.int.call({command:p.TileLayer_Modifier_Add,data:F(a)},b)}addModifierByShapeFile(a,b){return this.int.call({command:p.TileLayer_Modifier_Add,data:F(a)},b)}addModifier(a,b,c,e,d){this.addModifiers([{id:a,tileLayerId:b,coordinates:c,ententBufferSize:e}])}updateModifier(a,b,c,e,d){return this.int.call({command:p.TileLayer_Modifier_Update,data:F([{id:a,tileLayerId:b,coordinates:c,
ententBufferSize:e}])},d)}deleteModifier(a,b,c){return this.int.call({command:p.TileLayer_Modifier_Delete,id:a,tileLayerId:b},c)}clearModifier(a,b){return this.int.call({command:p.TileLayer_Modifier_Clear,ids:K(a)},b)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,viewportVisible:!!(b&ba.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&ba.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&ba.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&ba.V4)});return this.int.call({command:p.TileLayer_SetViewportVisible,
id:a,data:e},c)}getObjectIDs(a,b){return this.int.call({command:p.TileLayer_GetObjectIDs,ids:K(a)},b)}getActorInfo(a,b){return this.int.call({command:p.TileLayer_Actor_GetInfo,data:F(a)},b)}addHoleByShapeFile(a,b){return this.int.call({command:p.TileLayer_CutPolygon_Add,data:F(a)},b)}addHole(a,b){return this.int.call({command:p.TileLayer_CutPolygon_Add,data:F(a)},b)}updateHole(a,b,c,e,d){return this.int.call({command:p.TileLayer_CutPolygon_Update,data:F({id:a,tileLayerId:b,coordinates:c,isReverseCut:e})},
d)}deleteHole(a,b,c){return this.int.call({command:p.TileLayer_CutPolygon_Delete,id:a,tileLayerId:b},c)}clearHole(a,b){return this.int.call({command:p.TileLayer_CutPolygon_Clear,ids:K(a)},b)}setViewHeightRange(a,b,c,e){return this.int.call({command:p.TileLayer_SetViewHeightRange,data:[{id:a,minVisibleHeight:b,maxVisibleHeight:c}]},e)}setPointCloudSize(a,b,c){return this.int.call({command:p.TileLayer_SetPointSize,data:[{tileLayerId:a,size:b}]},c)}}class Ib extends Q{constructor(a){super(a,"Vehicle")}add(a,
b){this._fixVehicleData(a);return super._add(a,b)}_fixVehicleData(a){if(a instanceof Array)for(let b of a)this._fixVehicleProperty(b);else this._fixVehicleProperty(a)}_fixVehicleProperty(a){0<a.colorType?a.initFunctionInfos=[{functionName:"setVehicleColor",parameters:[{paramType:2,paramValue:a.colorType}]}]:a.colorType=0}update(a,b){this._fixVehicleData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d,h,g){return this.int.call({command:p.Vehicle_Focus,
ids:F(a),distance:c,flyTime:e,rotation:d,distanceRotation:h,followEnabled:b},g)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setWayPoint(a,b){return this.int.call({command:p.Vehicle_AddWayPoints,data:F(a)},b)}moveTo(a,b){return this.int.call({command:p.Vehicle_MoveTo,data:F(a)},b)}start(a,b){if(S(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(0<=a.timeStamp)a.active=!0;else if(a instanceof Array)for(let c of a)c.active=!0;else{console.error("\u53c2\u6570\u975e\u6cd5!");
return}return this.int.call({command:p.Vehicle_Update,data:F(a)},b)}}pause(a,b){a=this._fixIds(a,!1);if(!S(a))return this.int.call({command:p.Vehicle_Update,data:a},b)}resume(a,b){a=this._fixIds(a,!0);if(!S(a))return this.int.call({command:p.Vehicle_Update,data:a},b)}stop(a,b){a=this._fixIds(a,!1);if(!S(a))return this.int.call({command:p.Vehicle_Update,data:a},b)}_fixIds(a,b){let c=[];if(S(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(a instanceof Array){let e=!1;for(let d of a){if("string"!=
typeof d){e=!0;break}c.push({id:d,active:b})}if(e){console.error("\u53c2\u6570\u975e\u6cd5!");return}return c}if("string"!==typeof a||S(a))console.error("\u53c2\u6570\u975e\u6cd5!");else return c.push({id:a,active:b}),c}}callBatchFunction(a,b){return this.int.call({command:p.Vehicle_CallBatchFunction,data:F(a)},b)}}class Jb extends Q{constructor(a){super(a,"VideoProjection","frustumColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
...
"distance",b,c)}setDepthCulling(a,b,c){return super._updateOneProp(a,"depthCulling",b,c)}setFrustumColor(a,b,c){return super._updateOneProp(a,"frustumColor",b,c)}}class Kb extends Q{constructor(a){super(a,"WaterFlowField")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,
b)}}class Lb extends Q{constructor(a){super(a,"WaterMesh","waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setIndices(a,
b,c){return super._updateOneProp(a,"indices",b,c)}setNormals(a,b,c){return super._updateOneProp(a,"normals",b,c)}setWaterColor(a,b,c){return super._updateOneProp(a,"waterColor",b,c)}setWaterSpeed(a,b,c){return super._updateOneProp(a,"waterSpeed",b,c)}setWaterUVRepeat(a,b,c){return super._updateOneProp(a,"waterUVRepeat",b,c)}setWaterDirection(a,b,c){return super._updateOneProp(a,"waterDirection",b,c)}setWaterWaveScale(a,b,c){return super._updateOneProp(a,"waveScale",b,c)}}var za="en",ta={},Aa={VersionMismatch:["\u8b66\u544a\uff1a\n--------------------------------------------------\n    ac.min.js\u6587\u4ef6\u7248\u672c\uff08{0}\uff09\u548c\u4e91\u6e32\u67d3\u670d\u52a1\u5668\u7248\u672c\uff08{1}\uff09\u4e0d\u4e00\u81f4\uff0c\n    \u53ef\u80fd\u9020\u6210\u63a5\u53e3\u8c03\u7528\u9519\u8bef\u6216\u5d29\u6e83\uff0c\u8bf7\u786e\u8ba4!",
...
"browser decoding time"],DecodingTime:["\u89e3\u7801\u65f6\u95f4\uff1a","DecTime:"],DecodeFrames:["\u89e3\u7801\u5e27\u6570\uff1a","DecFrame:"],DecodeFramesTip:["\u5df2\u89e3\u7801\u7684\u5e27\u6570 / \u5df2\u89e3\u7801\u7684\u5173\u952e\u5e27\u6570\u91cf","Decoded Frames / Decoded Keyframes"],Bitrate:["\u7801\u7387\uff1a","Bitrate:"],FPS:["\u5e27\u7387\uff1a","FPS:"],FPSTip:["\u6e32\u67d3\u5e27\u7387/\u89c6\u9891\u5e27\u7387","Rendering frame rate/video frame rate"],MaxQP:["QP\u4e0a\u9650\uff1a",
...
a[1];return[Math.atan2(b[2]-a[2],Math.sqrt(e*e+d*d))*c,Math.atan2(e,d)*c-90,0]}lockByBBox(a,b){return this.int.call({command:p.Camera_LockBBox,bbox:a},b)}unlock(a){return this.int.call({command:p.Camera_UnLockBBox},a)}exitWorld(a,b,c){return this.int.call({command:p.Camera_ExitEarthCapture,coordinate:a,rotation:b},c)}enterWorld(a){return this.int.call({command:p.Camera_EnterEarthCapture},a)}}class Nb{constructor(a){this.int=a}screen2World(a,b,c){return this.int.call({command:p.Coord_Screen2World,
screenPosition:[a,b]},c)}world2Screen(a,b,c,e){return this.int.call({command:p.Coord_World2Screen,worldlocation:[a,b,c]},e)}gcs2pcs(a,b,c){"function"==typeof b&&(c=b);S(b)&&(b=1);if(1==b)return this.int.call({command:p.Coord_GCS2PCS,coordinates:R(a)},c);2==b?this.transform(R(a),2,0,c):3==b?this.transform(R(a),3,0,c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}pcs2gcs(a,b,c){"function"==typeof b&&(c=b);S(b)&&(b=1);if(1==b)return this.int.call({command:p.Coord_PCS2GCS,coordinates:R(a)},
c);2==b?this.transform(R(a),0,2,c):3==b?this.transform(R(a),0,3,c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}transform(a,b,c,e){return this.int.call({command:p.Coord_Transform,coordinates:R(a),src:b,dest:c},e)}}class Ob{constructor(a){this.int=a}start(a){return this.int.call0(p.EditHelper_Start,a)}cancel(a){return this.int.call0(p.EditHelper_Quit,a)}finish(a,b){return this.int.call({command:p.EditHelper_Finish,withOffset:a||!0},b)}setParam(a,b,c,e){return this.int.call({command:p.EditHelper_SetParam,
lineType:a,buildType:b,color:E(c)},e)}}class Pb{constructor(a){this.int=a}setVisibility(a,b){return this.int.call({command:p.InfoTree_SetVisibility,layers:F(a)},b)}show(a,b){return this.int.call({command:p.InfoTree_Show,ids:K(a)},b)}hide(a,b){return this.int.call({command:p.InfoTree_Hide,ids:K(a)},b)}enableXRay(a,b,c){return this.int.call({command:p.InfoTree_EnableXRay,ids:F(a),color:E(b)},c)}disableXRay(a,b){return this.int.call({command:p.InfoTree_DisableXRay,ids:F(a)},b)}showByGroupId(a,b){return this.int.call({command:p.InfoTree_ShowByGroupId,
ids:K(a)},b)}hideByGroupId(a,b){return this.int.call({command:p.InfoTree_HideByGroupId,ids:K(a)},b)}highlightByGroupId(a,b){return this.int.call({command:p.InfoTree_HighlightByGroupId,ids:K(a)},b)}deleteByGroupId(a,b){return this.int.call({command:p.InfoTree_DeleteByGroupId,ids:K(a)},b)}get(a){return this.int.call0(p.InfoTree_Get,a)}focus(a,b){return this.int.call({command:p.InfoTree_Focus,ids:K(a)},b)}}class Qb{constructor(a){this.int=a;this.apiVersion="5.4";this.apiVersionServer=""}isApiVersionMatched(){return"5.4"==
this.apiVersionServer}addImageButtons(a,b){return this.int.call({command:p.Misc_AddImageButton,data:F(a)},b)}deleteImageButtons(a,b){return this.int.call({command:p.Misc_DeleteImageButton,ids:K(a)},b)}addAnimatedImageButtons(a,b){return this.int.call({command:p.Misc_AddAnimatedImageButton,data:F(a)},b)}setApiVersionReceived(a){this.int.onApiVersionReceived=a}playVideo(a,b,c,e,d,h,g){return this.int.call({command:p.Misc_PlayVideo,data:[{id:a.toString(),position:[b,c],size:[e,d],url:h}]},g)}stopPlayVideo(a,
b){return this.int.call({command:p.Misc_StopPlayVideo,ids:K(a)},b)}playMovie(a,b,c){"function"==typeof b&&(c=b,b=!1);return this.int.call({command:p.Misc_PlayMovie,loop:b,url:a},c)}stopMovie(a){return this.int.call({command:p.Misc_StopMovie},a)}setWindowResolution(a,b,c){return this.int.call({command:p.Misc_SetWindowResolution,cx:a,cy:b,mode:0},c)}callBPFunction(a,b){return this.int.call({command:p.Misc_CallBPFunction,data:F(a)},b)}enterReportMode(a){return this.int.call0(p.Misc_EnterReportMode)}exitReportMode(a){return this.int.call0(p.Misc_ExitReportMode,
a)}showAllFoliages(a){return this.int.call0(p.Misc_ShowAllFoliages,a)}hideAllFoliages(a){return this.int.call0(p.Misc_HideAllFoliages,a)}startProcess(a,b,c,e){"function"==typeof c&&(e=c,c=!0);return this.int.call({command:p.Misc_StartProcess,appName:a,commandLine:b,visible:c},e)}enterMultiViewportMode(a,b,c,e){if(null==b||void 0==b)b="#DEA309";if(null==c||void 0==c)c=2;return this.int.call({command:p.Misc_EnterMultiViewport,type:a,lineColor:E(b),lineThickness:c},e)}exitMultiViewportMode(a){return this.int.call({command:p.Misc_ExitMultiViewport},
a)}setActiveViewport(a,b){return this.int.call({command:p.Misc_SetActivateMultiViewport,viewIndex:F(a)},b)}getActiveViewport(a){return this.int.call({command:p.Misc_GetActivateMultiViewport},a)}setMultiviewportInteractSync(a,b){this.setCameraFollow4Viewport(a,b)}setCameraFollow4Viewport(a,b){return this.int.call({command:p.Misc_UpdateMultiViewport,moverTogether:a},b)}downloadPakFiles(a,b){return this.int.call({command:p.Misc_downloadPakFiles,ids:F(a)},b)}getConvexPolygon(a,b){return this.int.call({command:p.Misc_ConvexHull2D,
data:F(a)},b)}getMaterial(a,b){return this.int.call({command:p.Misc_QueryActorOrMaterial,idOrPaths:F(a)},b)}getBPFunction(a,b){return this.int.call({command:p.Misc_QueryActorOrMaterial,idOrPaths:F(a)},b)}startPolygonClip(a,b,c){return this.int.tools.startPolygonClip(a,b,c)}stopClip(a){return this.int.tools.stopClip(a)}playAnimation(a,b){return this.int.camera.playAnimation(a,b)}stopAnimation(a){return this.int.camera.stopAnimation(a)}setDateTime(a,b,c,e,d,h,g){return this.int.weather.setDateTime(a,
b,c,e,d,h,g)}setQueryToolState(a,b){return this.int.call({"c.ommand":p.Settings_SetMousePickMask,mouseClick:a},b)}setCampassVisible(a,b){return this.int.settings.setCampassVisible(a,b)}setMainUIVisibility(a,b){return this.int.settings.setMainUIVisibility(a,b)}setMousePickMask(a,b){return this.int.settings.setMousePickMask(a,b)}}class Rb{constructor(a){this.int=a}setMapMode(a,b,c){b=b||{};return this.int.call({command:p.Settings_SetMapMode,mode:a,serviceType:b.serviceType||0,coordType:b.coordType||
0,mapPoint:b.mapPoint||[0,0],longitude:b.longitude||0,latitude:b.latitude||0,cache:b.cache||":memory:",style:b.style||"mapbox://styles/mapbox/streets-v10",groundHeight:b.groundHeight||0,renderMode:b.renderMode||0,decalMode:b.decalMode||1,serverURL:b.serverURL,coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(p.Settings_GetMapMode,a)}setWMTSLayerVisible(a,b){this.setwmtsLayerVisible(a,b)}setwmtsLayerVisible(a,b){return this.int.call({command:p.Settings_SetWMTSLayerVisible,
...
alignment:a,playMode:b,moveInOtherView:c},e)}getReportMode(a){return this.int.call({command:p.Settings_GetReport},a)}setControlMode(a,b,c,e,d){return this.int.call({command:p.Settings_SetControl,speed:a,yawSpeed:b,rotateSelf:c,useFemale:e},d)}getControlMode(a){return this.int.call({command:p.Settings_GetControl},a)}setPostProcessMode(a,b){let c=1E3,e=1E3;0<=a.terrainGlobalAlpha&&1>=a.terrainGlobalAlpha&&(c=1E3*a.terrainGlobalAlpha);0<=a.osgbGlobalAlpha&&1>=a.osgbGlobalAlpha&&(e=1E3*a.osgbGlobalAlpha);
return this.int.call({command:p.Settings_SetPostProcess,contrast:a.contrast,saturation:a.saturation,lensFlareIntensity:a.lensFlareIntensity,ambientIntensity:a.ambientIntensity,bloomIntensity:a.bloomIntensity,lutMode:a.lutMode,lutIntensity:a.lutIntensity,darkCorner:a.darkCorner,screenPercentage:a.screenPercentage,terrainGlobalAlpha:c,terrainGlobalLitStatus:a.terrainGlobalLitStatus,osgbGlobalLitStatus:a.osgbGlobalLitStatus,osgbGlobalAlpha:e,antiAliasing:a.antiAliasing,tonemapper:a.tonemapper,postProcessEffects:a.postProcessEffects,
dofMode:a.dofMode,wireThickness:a.wireThickness,receiveDecalMode:a.receiveDecalMode},b)}getPostProcessMode(a){return this.int.call({command:p.Settings_GetPostProcess},a)}setCameraMode(a,b,c,e,d){e&&"function"==typeof e&&(d=e);return this.int.call({command:p.Settings_SetCamera,nearClipPlane:a,fovH:b,minCamHeight:c,maxCamHeight:e},d)}getCameraMode(a){return this.int.call({command:p.Settings_GetCamera},a)}setMapMode(a,b,c){b=b||{};return this.int.call({command:p.Settings_SetMapMode,mode:a,serviceType:b.serviceType||
0,coordType:b.coordType||0,mapPoint:b.mapPoint||[0,0],longitude:b.longitude||0,latitude:b.latitude||0,cache:b.cache||":memory:",style:b.style||"mapbox://styles/mapbox/streets-v10",groundHeight:b.groundHeight||0,renderMode:b.renderMode||0,decalMode:b.decalMode||1,serverURL:b.serverURL,coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(p.Settings_GetMapMode,a)}}class Tb{constructor(a){this.int=a}startPolygonClip(a,b,c){return this.int.call({command:p.Tools_StartPolygonClip,
data:F({id:"0",coordinates:O(a),toggleImageCut:b})},c)}startPlaneClip(a,b,c,e,d){return this.int.call({command:p.Tools_StartPlaneClip,location:a,rotation:b,isShowPlane:c,isEdit:e},d)}startVolumeClip(a,b,c,e,d,h){return this.int.call({command:p.Tools_StartVolumeClip,bbox:a,rotation:d,value:b,isShowPlane:c,isEdit:e},h)}updateVolumeClip(a,b,c,e,d,h){return this.int.call({command:p.Tools_UpdateVolumeClip,bbox:a,rotation:d,value:b,isShowPlane:c,isEdit:e},h)}stopClip(a){return this.stopPolygonClip(a)}stopPolygonClip(a){return this.int.call0(p.Tools_StopClip,
a)}stopPlaneClip(a){return this.int.call({command:p.Tools_StopPlaneClip},a)}stopVolumeClip(a){return this.int.call({command:p.Tools_StopVolumeClip},a)}setMeasurement(a,b,c){b=b||{};return this.int.call({command:p.Tools_SetMeasurement,type:a,pointSize:b.pointSize,textSize:b.textSize,textColor:E(b.textColor),pointColor:E(b.pointColor),lineColor:E(b.lineColor),areaColor:E(b.areaColor),showCoordinateText:b.showCoordinateText},c)}startMeasurement(a){return this.int.call0(p.Tools_StartMeasurement,a)}stopMeasurement(a){return this.int.call0(p.Tools_StopMeasurement,
a)}lineIntersect(a,b,c){return this.int.call({command:p.Tools_LineIntersect,data:[{start:a,end:b}],highPrecision:!1,returnDetails:!0},c)}linesIntersect(a,b,c,e){return this.int.call({command:p.Tools_LineIntersect,data:F(a),highPrecision:b,returnDetails:c},e)}startGeometryEdit(a,b,c){return this.int.call({command:p.Tools_StartGeometryEdit,id:a,type:b},c)}stopGeometryEdit(a){return this.int.call0(p.Tools_StopGeometryEdit,a)}startSkylineAnalysis(a,b){a=a||{};a.outlineColor&&(a.outlineColor=E(a.outlineColor));
a.sceneColor&&(a.sceneColor=E(a.sceneColor));a.skylineColor&&(a.skylineColor=E(a.skylineColor));a.backgroundColor&&(a.backgroundColor=E(a.backgroundColor));if(a.tileLayers){a.tileLayers=F(a.tileLayers);for(let c of a.tileLayers)c.hasOwnProperty("color")&&(c.color=E(c.color))}a.command=p.Tools_StartSkylineAnalysis;return this.int.call(a,b)}stopSkylineAnalysis(a){return this.int.call0(p.Tools_StopSkylineAnalysis,a)}exportSkyline(a,b,c,e){c=c||{};c.skylineColor&&(c.skylineColor=E(c.skylineColor));c.backgroundColor&&
(c.backgroundColor=E(c.backgroundColor));if(c.tileLayers){c.tileLayers=F(c.tileLayers);for(let d of c.tileLayer)d.hasOwnProperty("color")&&(d.color=E(d.color))}return this.int.call({command:p.Tools_ExportSkyline,path:a,size:b,skylineColor:c.skylineColor,backgroundColor:c.backgroundColor},e)}startViewshedAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=E(a.visibleColor));a.invisibleColor&&(a.invisibleColor=E(a.invisibleColor));a.command=p.Tools_StartViewshedAnalysis;return this.int.call(a,b)}stopViewshedAnalysis(a){return this.int.call0(p.Tools_StopViewshedAnalysis,
...
else{if(a.startHour==a.endHour){if(a.startMinute==a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u7b49\u4e8e\u7ed3\u675f\u65f6\u95f4");return}if(a.startMinute>a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u5927\u4e8e\u7ed3\u675f\u65f6\u95f4");return}}S(a.groundElevation)||(c=a.groundElevation,!isNaN(parseFloat(c))&&isFinite(c)&&(a.undersideHeight=a.groundElevation,delete a.groundElevation));a.command=p.Tools_StartSunshineAnalysis;return this.int.call(a,b)}else console.error("\u53c2\u6570endTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");
...
var m=void 0;if("environment"===A.exact||"environment"===A.ideal)m=["back","rear"];else if("user"===A.exact||"user"===A.ideal)m=["front"];if(m)return q.mediaDevices.enumerateDevices().then(function(n){n=n.filter(function(z){return"videoinput"===z.kind});var x=n.find(function(z){return m.some(function(B){return z.label.toLowerCase().includes(B)})});!x&&n.length&&m.includes("back")&&(x=n[n.length-1]);x&&(r.video.deviceId=A.exact?{exact:x.deviceId}:{ideal:x.deviceId});r.video=f(r.video);h("chrome: "+
...
!u.getAudioTracks().length||y.video&&!u.getVideoTracks().length)throw u.getTracks().forEach(function(A){A.stop()}),new DOMException("","NotFoundError");return u},function(u){return Promise.reject(t(u))})})}}}};var d=function(g){if(g&&g.__esModule)return g;var q={};if(null!=g)for(var k in g)Object.prototype.hasOwnProperty.call(g,k)&&(q[k]=g[k]);q.default=g;return q}(a("../utils.js")),h=d.log},{"../utils.js":15}],6:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});var e="function"===
...
{get:function(){return u}});this._sctp=y}return w.apply(this,arguments)}}};c.shimSendThrowTypeError=function(g){function q(f,l){var t=f.send;f.send=function(){var w=arguments[0];w=w.length||w.size||w.byteLength;if("open"===f.readyState&&l.sctp&&w>l.sctp.maxMessageSize)throw new TypeError("Message too large (can send a maximum of "+l.sctp.maxMessageSize+" bytes)");return t.apply(f,arguments)}}if(g.RTCPeerConnection&&"createDataChannel"in g.RTCPeerConnection.prototype){var k=g.RTCPeerConnection.prototype.createDataChannel;
g.RTCPeerConnection.prototype.createDataChannel=function(){var f=k.apply(this,arguments);q(f,this);return f};h.wrapPeerConnectionEvent(g,"datachannel",function(f){q(f.channel,f.target);return f})}};c.shimConnectionState=function(g){if(g.RTCPeerConnection&&!("connectionState"in g.RTCPeerConnection.prototype)){var q=g.RTCPeerConnection.prototype;Object.defineProperty(q,"connectionState",{get:function(){return{completed:"connected",checking:"connecting"}[this.iceConnectionState]||this.iceConnectionState},
...
q[k]=function(){this._connectionstatechangepoly||(this._connectionstatechangepoly=function(l){var t=l.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;var w=new Event("connectionstatechange",l);t.dispatchEvent(w)}return l},this.addEventListener("iceconnectionstatechange",this._connectionstatechangepoly));return f.apply(this,arguments)}})}};c.removeAllowExtmapMixed=function(g){if(g.RTCPeerConnection){var q=h.detectBrowser(g);if(!("chrome"===q.browser&&
71<=q.version||"safari"===q.browser&&605<=q.version)){var k=g.RTCPeerConnection.prototype.setRemoteDescription;g.RTCPeerConnection.prototype.setRemoteDescription=function(f){f&&f.sdp&&-1!==f.sdp.indexOf("\na=extmap-allow-mixed")&&(f.sdp=f.sdp.split("\n").filter(function(l){return"a=extmap-allow-mixed"!==l.trim()}).join("\n"));return k.apply(this,arguments)}}}};var d=(b=a("sdp"))&&b.__esModule?b:{default:b},h=function(g){if(g&&g.__esModule)return g;var q={};if(null!=g)for(var k in g)Object.prototype.hasOwnProperty.call(g,
...
8:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.filterIceServers=function(d,h){var g=!1;d=JSON.parse(JSON.stringify(d));return d.filter(function(q){if(q&&(q.urls||q.url)){var k=q.urls||q.url;q.url&&!q.urls&&e.deprecated("RTCIceServer.url","RTCIceServer.urls");var f="string"===typeof k;f&&(k=[k]);k=k.filter(function(l){return 0===l.indexOf("stun:")?!1:(l=l.startsWith("turn")&&!l.startsWith("turn:[")&&l.includes("transport=udp"))&&!g?g=!0:l&&!g});delete q.url;q.urls=f?k[0]:k;return!!k.length}})};
...
q=h&&h.navigator;h=h&&h.MediaStreamTrack;q.getUserMedia=function(w,r,y){d.deprecated("navigator.getUserMedia","navigator.mediaDevices.getUserMedia");q.mediaDevices.getUserMedia(w).then(r,y)};if(!(55<g.version&&"autoGainControl"in q.mediaDevices.getSupportedConstraints())){var k=function(w,r,y){r in w&&!(y in w)&&(w[y]=w[r],delete w[r])},f=q.mediaDevices.getUserMedia.bind(q.mediaDevices);q.mediaDevices.getUserMedia=function(w){"object"===("undefined"===typeof w?"undefined":e(w))&&"object"===e(w.audio)&&
(w=JSON.parse(JSON.stringify(w)),k(w.audio,"autoGainControl","mozAutoGainControl"),k(w.audio,"noiseSuppression","mozNoiseSuppression"));return f(w)};if(h&&h.prototype.getSettings){var l=h.prototype.getSettings;h.prototype.getSettings=function(){var w=l.apply(this,arguments);k(w,"mozAutoGainControl","autoGainControl");k(w,"mozNoiseSuppression","noiseSuppression");return w}}if(h&&h.prototype.applyConstraints){var t=h.prototype.applyConstraints;h.prototype.applyConstraints=function(w){"audio"===this.kind&&
"object"===("undefined"===typeof w?"undefined":e(w))&&(w=JSON.parse(JSON.stringify(w)),k(w,"autoGainControl","mozAutoGainControl"),k(w,"noiseSuppression","mozNoiseSuppression"));return t.apply(this,[w])}}}};var d=function(h){if(h&&h.__esModule)return h;var g={};if(null!=h)for(var q in h)Object.prototype.hasOwnProperty.call(h,q)&&(g[q]=h[q]);g.default=h;return g}(a("../utils"))},{"../utils":15}],14:[function(a,b,c){function e(g){return g&&void 0!==g.video?Object.assign({},g,{video:h.compactObject(g.video)}):
...
f=g.setLocalDescription,l=g.setRemoteDescription,t=g.addIceCandidate;g.createOffer=function(r,y){var u=q.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(r,y);return Promise.resolve()};g.createAnswer=function(r,y){var u=k.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(r,y);return Promise.resolve()};var w=function(r,y,u){r=f.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};g.setLocalDescription=w;w=function(r,y,
u){r=l.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};g.setRemoteDescription=w;w=function(r,y,u){r=t.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};g.addIceCandidate=w}};c.shimGetUserMedia=function(g){var q=g&&g.navigator;if(q.mediaDevices&&q.mediaDevices.getUserMedia){g=q.mediaDevices;var k=g.getUserMedia.bind(g);q.mediaDevices.getUserMedia=function(f){return k(e(f))}}!q.getUserMedia&&q.mediaDevices&&q.mediaDevices.getUserMedia&&(q.getUserMedia=function(f,
l,t){q.mediaDevices.getUserMedia(f).then(l,t)}.bind(q))};c.shimConstraints=e;c.shimRTCIceServerUrls=function(g){var q=g.RTCPeerConnection;g.RTCPeerConnection=function(k,f){if(k&&k.iceServers){for(var l=[],t=0;t<k.iceServers.length;t++){var w=k.iceServers[t];!w.hasOwnProperty("urls")&&w.hasOwnProperty("url")?(h.deprecated("RTCIceServer.url","RTCIceServer.urls"),w=JSON.parse(JSON.stringify(w)),w.urls=w.url,delete w.url,l.push(w)):l.push(k.iceServers[t])}k.iceServers=l}return new q(k,f)};g.RTCPeerConnection.prototype=
...
w&&A.trackId===u.id&&h(f,A,r)})});return r};var q=!0,k=!0},{}],16:[function(a,b,c){function e(l,t,w,r,y){t=f.writeRtpDescription(l.kind,t);t+=f.writeIceParameters(l.iceGatherer.getLocalParameters());t+=f.writeDtlsParameters(l.dtlsTransport.getLocalParameters(),"offer"===w?"actpass":y||"active");t+="a=mid:"+l.mid+"\r\n";t=l.rtpSender&&l.rtpReceiver?t+"a=sendrecv\r\n":l.rtpSender?t+"a=sendonly\r\n":l.rtpReceiver?t+"a=recvonly\r\n":t+"a=inactive\r\n";l.rtpSender&&(w=l.rtpSender._initialTrackId||l.rtpSender.track.id,
...
function h(l,t){var w={codecs:[],headerExtensions:[],fecMechanisms:[]},r=function(u,A){u=parseInt(u,10);for(var m=0;m<A.length;m++)if(A[m].payloadType===u||A[m].preferredPayloadType===u)return A[m]},y=function(u,A,m,n){u=r(u.parameters.apt,m);A=r(A.parameters.apt,n);return u&&A&&u.name.toLowerCase()===A.name.toLowerCase()};l.codecs.forEach(function(u){for(var A=0;A<t.codecs.length;A++){var m=t.codecs[A];if(u.name.toLowerCase()===m.name.toLowerCase()&&u.clockRate===m.clockRate&&("rtx"!==u.name.toLowerCase()||
...
break}}});return w}function g(l,t,w){return-1!=={offer:{setLocalDescription:["stable","have-local-offer"],setRemoteDescription:["stable","have-remote-offer"]},answer:{setLocalDescription:["have-remote-offer","have-local-pranswer"],setRemoteDescription:["have-local-offer","have-remote-pranswer"]}}[t][l].indexOf(w)}function q(l,t){var w=l.getRemoteCandidates().find(function(r){return t.foundation===r.foundation&&t.ip===r.ip&&t.port===r.port&&t.priority===r.priority&&t.protocol===r.protocol&&t.type===
...
Y=M.iceGatherer,L=M.iceTransport,J=M.dtlsTransport,P=M.localCapabilities,U=M.remoteCapabilities;if(!(f.isRejected(C)&&0===f.matchPrefix(C,"a=bundle-only").length||M.rejected)){var Z=f.getIceParameters(C,z);C=f.getDtlsParameters(C,z);B&&(C.role="server");n.usingBundle&&0!==G||(n._gather(M.mid,G),"new"===L.state&&L.start(Y,Z,B?"controlling":"controlled"),"new"===J.state&&J.start(C));G=h(P,U);n._transceive(M,0<G.codecs.length,!1)}})}n._localDescription={type:m.type,sdp:m.sdp};"offer"===m.type?n._updateSignalingState("have-local-offer"):
...
la||"UDP/DTLS/SCTP"===la))n.transceivers[J]={mid:na,kind:U,protocol:la,rejected:!0};else{!Z&&n.transceivers[J]&&n.transceivers[J].rejected&&(n.transceivers[J]=n._createTransceiver(U,!0));var Ba=f.parseRtpParameters(L);if(!Z){var oa=f.getIceParameters(L,C);var Ca=f.getDtlsParameters(L,C);Ca.role="client"}la=f.parseRtpEncodingParameters(L);var Da=f.parseRtcpParameters(L),Ea=0<f.matchPrefix(L,"a=end-of-candidates",C).length,ma=f.matchPrefix(L,"a=candidate:").map(function(X){return f.parseCandidate(X)}).filter(function(X){return 1===
...
if("offer"!==m.type||Z)"answer"!==m.type||Z||(N=n.transceivers[J],ja=N.iceGatherer,U=N.iceTransport,na=N.dtlsTransport,ha=N.rtpReceiver,Z=N.sendEncodingParameters,L=N.localCapabilities,n.transceivers[J].recvEncodingParameters=la,n.transceivers[J].remoteCapabilities=Ba,n.transceivers[J].rtcpParameters=Da,ma.length&&"new"===U.state&&(!G&&!Ea||M&&0!==J?ma.forEach(function(X){q(N.iceTransport,X)}):U.setRemoteCandidates(ma)),M&&0!==J||("new"===U.state&&U.start(ja,oa,"controlling"),"new"===na.state&&na.start(Ca)),
!h(N.localCapabilities,N.remoteCapabilities).codecs.filter(function(X){return"rtx"===X.name.toLowerCase()}).length&&N.sendEncodingParameters[0].rtx&&delete N.sendEncodingParameters[0].rtx,n._transceive(N,"sendrecv"===P||"recvonly"===P,"sendrecv"===P||"sendonly"===P),!ha||"sendrecv"!==P&&"sendonly"!==P?delete N.rtpReceiver:(P=ha.track,W?(x[W.stream]||(x[W.stream]=new l.MediaStream),w(P,x[W.stream]),z.push([P,ha,x[W.stream]])):(x.default||(x.default=new l.MediaStream),w(P,x.default),z.push([P,ha,x.default]))));
else{var N=n.transceivers[J]||n._createTransceiver(U);N.mid=na;N.iceGatherer||(N.iceGatherer=n._createIceGatherer(J,M));ma.length&&"new"===N.iceTransport.state&&(!Ea||M&&0!==J?ma.forEach(function(X){q(N.iceTransport,X)}):N.iceTransport.setRemoteCandidates(ma));L=l.RTCRtpReceiver.getCapabilities(U);15019>t&&(L.codecs=L.codecs.filter(function(X){return"rtx"!==X.name}));Z=N.sendEncodingParameters||[{ssrc:1001*(2*J+2)}];oa=!1;if("sendrecv"===P||"sendonly"===P){oa=!N.rtpReceiver;var ha=N.rtpReceiver||
...
q=0;q<g.length;q++)d=g[q].trim().split("="),h[d[0].trim()]=d[1];return h};e.writeFmtp=function(d){var h="",g=d.payloadType;void 0!==d.preferredPayloadType&&(g=d.preferredPayloadType);if(d.parameters&&Object.keys(d.parameters).length){var q=[];Object.keys(d.parameters).forEach(function(k){d.parameters[k]?q.push(k+"="+d.parameters[k]):q.push(k)});h+="a=fmtp:"+g+" "+q.join(";")+"\r\n"}return h};e.parseRtcpFb=function(d){d=d.substr(d.indexOf(" ")+1).split(" ");return{type:d.shift(),parameter:d.join(" ")}};
e.writeRtcpFb=function(d){var h="",g=d.payloadType;void 0!==d.preferredPayloadType&&(g=d.preferredPayloadType);d.rtcpFeedback&&d.rtcpFeedback.length&&d.rtcpFeedback.forEach(function(q){h+="a=rtcp-fb:"+g+" "+q.type+(q.parameter&&q.parameter.length?" "+q.parameter:"")+"\r\n"});return h};e.parseSsrcMedia=function(d){var h=d.indexOf(" "),g={ssrc:parseInt(d.substr(7,h-7),10)},q=d.indexOf(":",h);-1<q?(g.attribute=d.substr(h+1,q-h-1),g.value=d.substr(q+1)):g.attribute=d.substr(h+1);return g};e.parseSsrcGroup=
function(d){d=d.substr(13).split(" ");return{semantics:d.shift(),ssrcs:d.map(function(h){return parseInt(h,10)})}};e.getMid=function(d){if(d=e.matchPrefix(d,"a=mid:")[0])return d.substr(6)};e.parseFingerprint=function(d){d=d.substr(14).split(" ");return{algorithm:d[0].toLowerCase(),value:d[1]}};e.getDtlsParameters=function(d,h){return{role:"auto",fingerprints:e.matchPrefix(d+h,"a=fingerprint:").map(e.parseFingerprint)}};e.writeDtlsParameters=function(d,h){var g="a=setup:"+h+"\r\n";d.fingerprints.forEach(function(q){g+=
...
return g&&d?{usernameFragment:g.substr(12),password:d.substr(10)}:null};e.writeIceParameters=function(d){return"a=ice-ufrag:"+d.usernameFragment+"\r\na=ice-pwd:"+d.password+"\r\n"};e.parseRtpParameters=function(d){for(var h={codecs:[],headerExtensions:[],fecMechanisms:[],rtcp:[]},g=e.splitLines(d)[0].split(" "),q=3;q<g.length;q++){var k=g[q],f=e.matchPrefix(d,"a=rtpmap:"+k+" ")[0];if(f){f=e.parseRtpMap(f);var l=e.matchPrefix(d,"a=fmtp:"+k+" ");f.parameters=l.length?e.parseFmtp(l[0]):{};f.rtcpFeedback=
...
"\r\n";g+="c=IN IP4 0.0.0.0\r\n";g+="a=rtcp:9 IN IP4 0.0.0.0\r\n";h.codecs.forEach(function(k){g+=e.writeRtpMap(k);g+=e.writeFmtp(k);g+=e.writeRtcpFb(k)});var q=0;h.codecs.forEach(function(k){k.maxptime>q&&(q=k.maxptime)});0<q&&(g+="a=maxptime:"+q+"\r\n");g+="a=rtcp-mux\r\n";h.headerExtensions&&h.headerExtensions.forEach(function(k){g+=e.writeExtmap(k)});return g};e.parseRtpEncodingParameters=function(d){var h=[],g=e.parseRtpParameters(d),q=-1!==g.fecMechanisms.indexOf("RED"),k=-1!==g.fecMechanisms.indexOf("ULPFEC"),
f=e.matchPrefix(d,"a=ssrc:").map(function(r){return e.parseSsrcMedia(r)}).filter(function(r){return"cname"===r.attribute}),l=0<f.length&&f[0].ssrc,t;f=e.matchPrefix(d,"a=ssrc-group:FID").map(function(r){return r.substr(17).split(" ").map(function(y){return parseInt(y,10)})});0<f.length&&1<f[0].length&&f[0][0]===l&&(t=f[0][1]);g.codecs.forEach(function(r){"RTX"===r.name.toUpperCase()&&r.parameters.apt&&(r={ssrc:l,codecPayloadType:parseInt(r.parameters.apt,10)},l&&t&&(r.rtx={ssrc:t}),h.push(r),q&&(r=
JSON.parse(JSON.stringify(r)),r.fec={ssrc:l,mechanism:k?"red+ulpfec":"red"},h.push(r)))});0===h.length&&l&&h.push({ssrc:l});var w=e.matchPrefix(d,"b=");w.length&&(w=0===w[0].indexOf("b=TIAS:")?parseInt(w[0].substr(7),10):0===w[0].indexOf("b=AS:")?950*parseInt(w[0].substr(5),10)-16E3:void 0,h.forEach(function(r){r.maxBitrate=w}));return h};e.parseRtcpParameters=function(d){var h={},g=e.matchPrefix(d,"a=ssrc:").map(function(q){return e.parseSsrcMedia(q)}).filter(function(q){return"cname"===q.attribute})[0];
...
e.parseSctpDescription=function(d){var h=e.parseMLine(d),g=e.matchPrefix(d,"a=max-message-size:"),q;0<g.length&&(q=parseInt(g[0].substr(19),10));isNaN(q)&&(q=65536);g=e.matchPrefix(d,"a=sctp-port:");if(0<g.length)return{port:parseInt(g[0].substr(12),10),protocol:h.fmt,maxMessageSize:q};if(0<e.matchPrefix(d,"a=sctpmap:").length)return d=e.matchPrefix(d,"a=sctpmap:")[0].substr(10).split(" "),{port:parseInt(d[0],10),protocol:d[1],maxMessageSize:q}};e.writeSctpDescription=function(d,h){d="DTLS/SCTP"!==
...
"unified-plan";this.tnClient=this.dcClient=this.pcClient=null;this.sdpConstraints={offerToReceiveAudio:0,offerToReceiveVideo:1,voiceActivityDetection:!1};this.dataChannelOptions={ordered:!0};this.lastStats={};this.playerId=0;this.latencyTestTimings=new Yb(this.events.onLatencyTimingsReady);this._bSendingAPI=!1;this._apiSendingQueue=[]}setVideo(a){this.video=a}logStartupInfo(a){if(this.events.onlog)this.events.onlog(a)}setupPeerConnection(){this.pcClient||(this.pcClient=new RTCPeerConnection(this.webRtcConfig),
...
content:b.substr(h*d,t)}}let k=0,f=t=>{for(t=this.dcClient.bufferedAmount;k<q.length;){var w=q[k++];let r=new DataView(new ArrayBuffer(4+2*w.stringLength)),y=0;r.setUint8(y,52);y++;r.setUint8(y,w.type);y++;r.setUint16(y,w.stringLength,!0);y+=2;w=w.content;for(let u=0;u<w.length;u++)r.setUint16(y,w.charCodeAt(u),!0),y+=2;t+=r.byteLength;this.send(r.buffer);if(k==g-1)console.log(`api(command: ${a.command}) slices send finished. bufferedamountlow calls: ${this.numOfEventCalls}`),this.dcClient.onbufferedamountlow=
null,this._bSendingAPI=!1,setTimeout(()=>this._continueSendAPI(),100);else if(t>l)break}},l=Math.max(8*e,1048576);this.dcClient.bufferedAmountLowThreshold=e;this.dcClient.onbufferedamountlow=t=>{this.numOfEventCalls++;f()};console.log(`sending api(command: ${a.command}) slices, count: ${g}`);f()}else{e=new DataView(new ArrayBuffer(4+2*c));d=0;e.setUint8(d,52);d++;e.setUint8(d,0);d++;e.setUint16(d,c,!0);d+=2;for(h=0;h<c;h++)e.setUint16(d,b.charCodeAt(h),!0),d+=2;this.send(e.buffer);this._bSendingAPI=
...
this.appendElement(this.el),document.addEventListener("fullscreenchange",()=>{this.el.title=H.getString("ExitFullscreen");this.el.innerHTML=T.isFullscreen()?ca.FullScreenExit:ca.FullScreenEnter;this.player.resize()}))}destroy(){this.el&&(this.removeElement(this.el),this.el=null)}setPosition(a,b){a||(a=this.container.getBoundingClientRect());this.el&&(this.el.style.left=`${b?38:5}px`,this.el.style.top=`${a.height-32}px`)}}const ea={BackSpace:8,Shift:16,Control:17,Alt:18,RightShift:253,RightControl:254,
RightAlt:255};class bc extends ia{constructor(a,b){super(a);this.video=null;this.useBuiltinCursors=b.useBuiltinCursors;this.keyEventTargetStr=b.keyEventTarget;this.keyEventTarget="document"==b.keyEventTarget?document:"none"==b.keyEventTarget?null:"video";this.callOnUserInteraction=()=>this.player.resetInteractTimestamp();this.fakeMouseWithTouches=!1;this.onMButtonDoubleClick=b.onMButtonDoubleClick;this.mouseKeyListener=b.mouseKeyListener;this.onActionEnable=!0;this.onEvents=b.onEvents;this.onVideoLoaded=
b.onVideoLoaded;document.addEventListener("WeixinJSBridgeReady",()=>{T.isInWeixinBrowser=!0;this.video.play()});this.create()}isVideoLoaded(){return!!this._isVideoLoaded}create(){this.video&&this.destroy();this.video||(this.video=document.createElement("video"),this.video.id=`streamingVideo_${this.uid}`,this.video.style="position:absolute;",this.video.playsInline=!0,this.video.muted=!0,this.video.autoplay=!0,this.video.disablepictureinpicture=!0,"video"===this.keyEventTarget&&(this.video.tabIndex=
1,this.keyEventTarget=this.video),this.appendElement(this.video),this.player.logStartupInfo("video element created"),this._isVideoLoaded=!1,this.video.addEventListener("loadedmetadata",()=>{this._isVideoLoaded=!0;this.video.onmouseenter({button:0,x:0,y:0});this.onVideoLoaded()},!0),this.setCursor());if("requestVideoFrameCallback"in HTMLVideoElement.prototype){const a=(b,c)=>{c.receiveTime&&c.expectedDisplayTime&&(this.rtc.lastStats.receiveToCompositeMs=c.presentationTime-c.receiveTime);this.video&&
this.video.requestVideoFrameCallback(a)};this.video.requestVideoFrameCallback(a)}}setWebRtcPlayer(a){(!this.video||T.isAndroidDevice||T.isIOSDevice&&!T.isInWeixinBrowser)&&this.create();this.rtc=a;this.rtc.setVideo(this.video)}setActionEventEnabled(a){this.onActionEnable=a}destroy(){this.video&&(this.removeElement(this.video),this.video=null)}valid(){return!!this.video}videoWidth(){let a;return null==(a=this.video)?void 0:a.videoWidth}videoHeight(){let a;return null==(a=this.video)?void 0:a.videoHeight}clientWidth(){let a;
return null==(a=this.video)?void 0:a.clientWidth}clientHeight(){let a;return null==(a=this.video)?void 0:a.clientHeight}setTrack(a){let b=a.streams[0];this.player.logStartupInfo("track: "+a.track.kind);"audio"==a.track.kind?(a=document.createElement("Audio"),a.autoplay=!0,a.srcObject=b,a.play(),this.player.logStartupInfo("audio element created")):"video"==a.track.kind&&this.video.srcObject!==b&&(this.video.srcObject=b)}setKeyEventTarget(a){this.keyEventTargetStr!=a&&(this.clearKeyboardEvents(),"video"==
a?(this.video&&(this.video.tabIndex=1),this.keyEventTarget=this.video,this.video.focus()):"document"==a?(this.keyEventTarget=document,this.video.focus()):this.keyEventTarget&&(this.keyEventTarget=null),this.keyEventTargetStr=a,this.registerKeyboardEvents())}clearKeyboardEvents(){this.keyEventTarget&&(this.keyEventTarget.onkeydown=null,this.keyEventTarget.onkeyup=null,this.keyEventTarget.onkeypress=null)}registerKeyboardEvents(){this.keyEventTarget&&(this.keyEventTarget.onkeydown=a=>{112<=a.keyCode&&
123>=a.keyCode||a.ctrlKey||this.sendKeydown(a);if(a.keyCode===ea.BackSpace)this.keyEventTarget.onkeypress({charCode:ea.BackSpace});this.callActionEventHander(5,a)},this.keyEventTarget.onkeyup=a=>{112<=a.keyCode&&123>=a.keyCode||a.ctrlKey||this.sendKeyup(a);this.callActionEventHander(6,a)},this.keyEventTarget.onkeypress=a=>{112<=a.keyCode&&123>=a.keyCode||this.sendKeypress(a);this.callActionEventHander(7,a)})}setCursor(){if(this.video)if(this.useBuiltinCursors)switch(this.mouseDownButton){case 0:this.video.setAttribute("class",
"streamingVideoCursorPan");break;case 1:this.video.setAttribute("class","streamingVideoCursorMove");break;case 2:this.video.setAttribute("class","streamingVideoCursorRotate");break;default:this.video.setAttribute("class","streamingVideoCursorPointer")}else this.video.setAttribute("class","streamingVideoNoCursor")}callActionEventHander(a,b){if(this.mouseKeyListener&&this.onActionEnable)switch(a){case 0:if(T.isFunction(this.mouseKeyListener.onMouseEnter))this.mouseKeyListener.onMouseEnter(b);break;
case 1:if(T.isFunction(this.mouseKeyListener.onMouseLeave))this.mouseKeyListener.onMouseLeave(b);break;case 2:if(T.isFunction(this.mouseKeyListener.onMouseMove))this.mouseKeyListener.onMouseMove(b);break;case 3:if(T.isFunction(this.mouseKeyListener.onMouseDown))this.mouseKeyListener.onMouseDown(b);break;case 4:if(T.isFunction(this.mouseKeyListener.onMouseUp))this.mouseKeyListener.onMouseUp(b);break;case 5:if(T.isFunction(this.mouseKeyListener.onKeyDown))this.mouseKeyListener.onKeyDown(b);break;case 6:if(T.isFunction(this.mouseKeyListener.onKeyUp))this.mouseKeyListener.onKeyUp(b);
break;case 7:if(T.isFunction(this.mouseKeyListener.onKeyPress))this.mouseKeyListener.onKeyPress(b)}}isMiddleDoubleClick(a){if(1==a.button){if(this.lastMClickTimestamp&&200>a.timeStamp-this.lastMClickTimestamp)return!0;this.lastMClickTimestamp=a.timeStamp}else this.lastMClickTimestamp=void 0;return!1}registerMouseEvents(){this.video.onmouseenter=a=>{this.sendMouseEnter();a.buttons&1&&this.sendMouseDown(0,a.offsetX,a.offsetY);a.buttons&2&&this.sendMouseDown(2,a.offsetX,a.offsetY);a.buttons&4&&this.sendMouseDown(1,
...
a)};this.video.onmousemove=a=>{this.sendMouseMove(a.offsetX,a.offsetY,a.movementX,a.movementY);a.preventDefault();if(0==this.mouseDownButton||2==this.mouseDownButton)this.setCursor(),this.mouseDownButton=void 0;this.callActionEventHander(2,a)};this.video.onmousedown=a=>{this.keyEventTarget==this.video&&this.video.focus();this.sendMouseEnter();this.isMiddleDoubleClick(a)&&this.onMButtonDoubleClick?(this.onMButtonDoubleClick(a.offsetX,a.offsetY),a.preventDefault()):(this.mouseDownButton=a.button,this.sendMouseDown(a.button,
a.offsetX,a.offsetY),a.preventDefault(),0!=a.button&&2!=a.button&&this.setCursor(),this.callActionEventHander(3,a))};this.video.onmouseup=a=>{this.mouseDownButton=void 0;this.sendMouseUp(a.button,a.offsetX,a.offsetY);a.preventDefault();this.setCursor();this.callActionEventHander(4,a)};this.video.oncontextmenu=a=>{a.preventDefault()};"onmousewheel"in this.video?this.video.addEventListener("mousewheel",a=>{this.sendMouseWheel(a.wheelDelta,a.offsetX,a.offsetY);a.preventDefault()},{passive:!1}):this.video.addEventListener("DOMMouseScroll",
a=>{this.sendMouseWheel(-120*a.detail,a.offsetX,a.offsetY);a.preventDefault()},!1)}registerTouchEvents(){this.ongoingTouches=[];this.copyTouch=({identifier:b,clientX:c,clientY:e,force:d})=>({identifier:b,clientX:c,clientY:e,force:d});this.ongoingTouchIndexById=b=>{for(let c=0;c<this.ongoingTouches.length;c++)if(this.ongoingTouches[c].identifier==b)return c;return-1};if(this.fakeMouseWithTouches){var a=void 0;this.video.addEventListener("touchstart",b=>{let c=this.container.getBoundingClientRect();
if(void 0===a){let e=b.changedTouches[0];a={id:e.identifier,x:e.clientX-c.left,y:e.clientY-c.top};this.video.onmouseenter(b);this.sendMouseDown(0,a.x,a.y)}b.preventDefault()},{passive:!1});this.video.addEventListener("touchend",b=>{let c=this.container.getBoundingClientRect();for(let e=0;e<b.changedTouches.length;e++){let d=b.changedTouches[e];if(d.identifier===a.id){this.sendMouseUp(0,d.clientX-c.left,d.clientY-c.top);this.video.onmouseleave(b);a=void 0;break}}b.preventDefault()},{passive:!1});this.video.addEventListener("touchmove",
b=>{var c=this.container.getBoundingClientRect();for(var e=0;e<b.touches.length;e++){let d=b.touches[e];if(d.identifier===a.id){e=d.clientX-c.left;c=d.clientY-c.top;this.sendMouseMove(e,c,e-a.x,c-a.y);a.x=e;a.y=c;break}}b.preventDefault()},{passive:!1})}else this.video.addEventListener("touchstart",b=>{b.preventDefault();null==this||this.onEvents(`ongoingTouches: ${this.ongoingTouches.length}, touches: ${b.touches.length}, changedTouches: ${b.changedTouches.length}`);this.ongoingTouches.length>b.touches.length-
b.changedTouches.length&&(this.onEvents&&this.onEvents(H.getString("TriggerSysTouch")),this.sendTouch(81,this.ongoingTouches),this.ongoingTouches=[]);b=b.changedTouches;for(let c=0;c<b.length;c++)this.ongoingTouches.push(this.copyTouch(b[c]));this.sendTouch(80,b)},{passive:!1}),this.video.addEventListener("touchend",b=>{b.preventDefault();b=b.changedTouches;this.sendTouch(81,b);for(let c=0;c<b.length;c++){let e=this.ongoingTouchIndexById(b[c].identifier);0<=e&&this.ongoingTouches.splice(e,1)}},{passive:!1}),
this.video.addEventListener("touchmove",b=>{b.preventDefault();this.sendTouch(82,b.touches)},{passive:!1})}resize(a){this.playerAspectRatio=this.container.clientHeight/this.container.clientWidth;this.videoAspectRatio=a?this.playerAspectRatio:this.videoHeight()/this.videoWidth()}normalizeAndQuantizeUnsigned(a,b){if(this.playerAspectRatio>this.videoAspectRatio){let c=this.playerAspectRatio/this.videoAspectRatio;a/=this.container.clientWidth;b=c*(b/this.container.clientHeight-.5)+.5}else a=this.videoAspectRatio/
this.playerAspectRatio*(a/this.container.clientWidth-.5)+.5,b/=this.container.clientHeight;return 0>a||1<a||0>b||1<b?{inRange:!1,x:65535,y:65535}:{inRange:!0,x:65536*a,y:65536*b}}normalizeAndQuantizeSigned(a,b){if(this.playerAspectRatio>this.videoAspectRatio){let c=this.playerAspectRatio/this.videoAspectRatio;a/=.5*this.container.clientWidth;b=c*b/(.5*this.container.clientHeight);return{x:32767*a,y:32767*b}}return{x:this.videoAspectRatio/this.playerAspectRatio*a/(.5*this.container.clientWidth)*32767,
y:b/(.5*this.container.clientHeight)*32767}}sendTouch(a,b){this.callOnUserInteraction();var c=new DataView(new ArrayBuffer(2+10*b.length));c.setUint8(0,a);c.setUint8(1,b.length);let e=2,d=[];for(let h=0;h<b.length;h++){let g=b[h],q=g.clientX-this.video.offsetLeft,k=g.clientY-this.video.offsetTop,f=this.normalizeAndQuantizeUnsigned(q,k),l=this.ongoingTouchIndexById(g.identifier);0>l?null==this||this.onEvents("can't figure out which touch to continue"):(c.setUint16(e,f.x,!0),e+=2,c.setUint16(e,f.y,
!0),e+=2,c.setInt32(e,l,!0),e+=4,c.setUint8(e,255*g.force,!0),e+=1,c.setUint8(e,f.inRange?1:0,!0),e+=1,this.onEvents&&d.push(`{${l} (${parseInt(q)},${parseInt(k)})->(${parseInt(f.x)},${parseInt(f.y)}) ${255*g.force} ${f.inRange?1:0}}`))}this.rtc.send(c.buffer);this.onEvents&&(c="",80==a?c="start":82==a?c="move":81==a&&(c="end"),a=`[${c}] N${b.length} ${d.join(",")}}`,this.onEvents(a))}sendKeydown(a){this.callOnUserInteraction();let b=xa(a),c;null==(c=this.onEvents)||c.call(this,`Send KeyDown, Code:${b}, Repeat:${a.repeat}`);
this.rtc.send((new Uint8Array([60,b,a.repeat])).buffer)}sendKeyup(a){this.callOnUserInteraction();a=xa(a);let b;null==(b=this.onEvents)||b.call(this,`Send KeyUp:${a}`);this.rtc.send((new Uint8Array([61,a])).buffer)}sendKeypress(a){this.callOnUserInteraction();var b;null==(b=this.onEvents)||b.call(this,`Send KeyPress:${a.charCode}`);b=new DataView(new ArrayBuffer(3));b.setUint8(0,62);b.setUint16(1,a.charCode,!0);this.rtc.send(b.buffer)}sendMouseEnter(){this.callOnUserInteraction();var a;null==(a=this.onEvents)||
a.call(this,"Send MouseEnter");a=new DataView(new ArrayBuffer(1));a.setUint8(0,70);this.rtc.send(a.buffer)}sendMouseLeave(){this.callOnUserInteraction();var a;null==(a=this.onEvents)||a.call(this,"Send MouseLeave");a=new DataView(new ArrayBuffer(1));a.setUint8(0,71);this.rtc.send(a.buffer)}sendMouseMove(a,b,c,e){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var d;null==(d=this.onEvents)||d.call(this,`Send MouseMove, X:${a}, Y:${b}, DeltaX:${c}, DeltaY:${e}`);a=this.normalizeAndQuantizeUnsigned(a,
b);c=this.normalizeAndQuantizeSigned(c,e);e=new DataView(new ArrayBuffer(9));e.setUint8(0,74);e.setUint16(1,a.x,!0);e.setUint16(3,a.y,!0);e.setInt16(5,c.x,!0);e.setInt16(7,c.y,!0);this.rtc.send(e.buffer)}}sendMouseDown(a,b,c){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var e;null==(e=this.onEvents)||e.call(this,`Send MouseDown, Button:${a}, X:${b}, Y:${c}`);b=this.normalizeAndQuantizeUnsigned(b,c);c=new DataView(new ArrayBuffer(6));c.setUint8(0,72);c.setUint8(1,a);c.setUint16(2,
b.x,!0);c.setUint16(4,b.y,!0);this.rtc.send(c.buffer)}}sendMouseUp(a,b,c){if(this.normalizeAndQuantizeUnsigned){var e;null==(e=this.onEvents)||e.call(this,`Send MouseUp, Button:${a}, X:${b}, Y:${c}`);b=this.normalizeAndQuantizeUnsigned(b,c);c=new DataView(new ArrayBuffer(6));c.setUint8(0,73);c.setUint8(1,a);c.setUint16(2,b.x,!0);c.setUint16(4,b.y,!0);this.rtc.send(c.buffer)}}sendMouseWheel(a,b,c){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var e;null==(e=this.onEvents)||e.call(this,
`Send MouseWheel, Delta:${a}, X:${b}, Y:${c}`);b=this.normalizeAndQuantizeUnsigned(b,c);c=new DataView(new ArrayBuffer(7));c.setUint8(0,75);c.setInt16(1,a,!0);c.setUint16(3,b.x,!0);c.setUint16(5,b.y,!0);this.rtc.send(c.buffer)}}}class cc extends ia{constructor(a,b,c){super(a);this.updateConnectionCount(b);this.createButton(c)}createButton(a){this.elButton||(this.elButton=document.createElement("button"),this.elButton.id=`liveStatusSwitchButton_${this.uid}`,this.elButton.innerHTML=ca.Information,this.elButton.title=
...
`<tr><td height="22" align="right">${H.getString("Bitrate")}</td><td colspan="2" id="i_bitrate_${this.uid}">-</td></tr>`+`<tr><td height="22" align="right" title="${H.getString("FPSTip")}">${H.getString("FPS")}</td><td colspan="2" title="${H.getString("FPSTip")}"><span id="i_framerateRender_${this.uid}">-</span> / <span id="i_framerateVideo_${this.uid}">-</span></td></tr>`+`<tr><td height="22" align="right">QP:</td><td colspan="2" id="i_qp_${this.uid}">0</td></tr>`+`<tr><td height="22" align="right" title="${H.getString("MaxQPTip")}">${H.getString("MaxQP")}</td><td colspan="2"><select id="i_settings_maxQP_${this.uid}" style="width:84px;"></select></td></tr>`+
...
else{this.elPanel.className="__liveStatusPanel __fadeoutComp";setTimeout(()=>{this.visible=!1;this.elPanel.style.display="none";this.player.rtc.sendEnableIntervalSendQP(!1);this.setNeedReposUI();this.resize()},500);return}else this.createPanel(),this.visible=!0,this.resize(),this.updateConnectionCount(),this.player.rtc.requestInitialSettings(),this.player.rtc.sendEnableIntervalSendQP(!0);this.setNeedReposUI();this.resize()}adjustMaxQP(a){return 18==a?(this.get("i_settings_maxQP")&&this.get("i_settings_maxQP").add(new Option(18,
18)),18):0>a?40:0<=a&&29>a?29:40<a?40:a}adjustMaxBitrate(a){return 300==a?(this.get("i_settings_maxBitrate")&&this.get("i_settings_maxBitrate").add(new Option(300,300)),300):10>a?10:100<a?100:a}formatNumber(a,b){return"undefined"==typeof a?"-":(new Intl.NumberFormat(window.navigator.language,{maximumFractionDigits:b||0})).format(a)}processValue(a){return a}updateButtonTip(a){this.elButton&&(this.elButton.title=a)}updateConnectionCount(a){void 0!=a&&(this.playersCount=a);this.setText("i_connections",
this.playersCount);this.updatePlayerId()}updatePlayerId(){this.setText("i_playerId",this.player.playerId+(this.player.isQualityController()?"-QC":""))}updateWebRtcStats(a){if(this.visible){var b=(a.timestamp-a.timestampStart)/1E3,c=new Intl.NumberFormat(window.navigator.language,{maximumFractionDigits:0,minimumIntegerDigits:2}),e=[],d=[60,60];for(let h=0;h<d.length;h++)e.push(b%d[h]),b/=d[h];e.push(b);b=c.format(e[0]);d=c.format(Math.floor(e[1]));c=c.format(Math.floor([e[2]]));this.setText("i_duration",
...
100>a?"red":1E3>a?"orange":"rgb(128,255,0)",b.innerText=this.formatNumber(a)+" kbps"):b.innerText="-"}updateInitialSettings(a){let b=this.adjustMaxQP(a.Encoder.MaxQP);this.setValue("i_settings_maxQP",b);a=this.adjustMaxBitrate(a.WebRTC.MaxBitrate/1E3/1E3);this.setValue("i_settings_maxBitrate",a)}updateQPAndRenderFPS(a,b){let c=this.get("i_qp");c.style.color=35<a?"red":26<a?"orange":"rgb(128,255,0)";c.innerText=a;this.get("i_framerateRender").innerText=this.processValue(b)}}class dc extends ia{constructor(a){super(a);
...
yield b.signallingConnection.checkParams(a);if(null!==c){if(!1===c.iid){b.api.log(`iid(${a.iid})${H.getString("InstanceNotExist")}`);return}if(!1===c.pid){b.api.log(`pid(${a.pid})${H.getString("ProjectNotExist")}`);return}}}b.destroy();b.options.iid=a.iid;b.options.pid=a.pid;b.options.reset=a.reset;b.constructUrlAndConnect()}})}set fullscreen(a){a?T.fullscreen(this.container):T.exitFullscreen()}get fullscreen(){return!!document.fullscreenElement}setActionEventEnabled(a){let b;null==(b=this.htmlVideo)||
...
v.MeasurementMode={Coordinate:1,Linear:2,Horizontal:3,Vertical:4,MultiPoint:5,TerrainArea:6};v.MousePickMask=qa;v.ODLineData=Va;v.PanelType={ViewshedAnalysis:0,SkylineAnalysis:1,ViewDomeAnalysis:2,VisiblityAnalysis:3,FloodFillAnalysis:4,SolarAnalysis:5,CutFillAnalysis:6,TerrainSlopeAnalysi:7,ContourLineAnalysis:8};v.PanoramaData=Xa;v.Polygon3DData=Ta;v.Polygon3DStyle={Wave:0,LoopLine:1,Gradual:2,DynamicGradual:3,WaveTransparent:4,WideWave:5,RotateArrow:6,RotateLine:7,RotateGradual:8,SingleColor:9,
SingleColorWithLight:10};v.PolygonData=Wa;v.PolygonStyle={SingleColor:0,CirclePoint:1,Volumn:2,Gradual:3,DynamicGradual:4,WaveTransparent:5,WideWave:6,RotateArrow:7,RotateLine:8,RotateGradual:9,OnTerrain:10};v.PolylineData=Ua;v.PolylineStyle={Arrow:0,Arrow1:1,Flow:2,Beam:3,Normal:4,OnTerrain:5,DottedNormal:6,DottedCircle:7};v.RadiationPointData=Sa;v.RendererType={SimpleRenderer:0,UniqueValueRenderer:1,ClassBreaksRenderer:2};v.TagData=La;v.TileLayerActorData=fa;v.TileLayerData=Za;v.VERSION="5.4";v.VehicleViewMode=
{FirstPerson:0,ThirdPerson:1};v.VideoProjectionData=bb;v.Viewport=ba;v.WaterFlowFieldStyle={HeatMap:0,Water:1};v.WebUIData=Ma;v.__onCefResponse=function(a,b){if(ua)ua.onConnectionMessage(a,b)};Object.defineProperty(v,"__esModule",{value:!0});return v}({});
